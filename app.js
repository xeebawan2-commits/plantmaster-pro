...
async function canUseBranding(){
  try{
    ...
    return !!(r.data?.plan?.features?.white_label);
...
async function renderCompanyProfile(){
  ...
  const upsell=brandOK?'':`<div class="span-2 card" style="border-color:#1e3a5f;background:#0d1b2e;display:flex;gap:12px;align-items:flex-start;padding:14px">
      ...
      <div><b style="color:#7aa2f7">Company branding is a paid feature</b>
      <p style="margin:6px 0 10px;font-size:13.5px;opacity:.85">Put your own logo, application name and colours across the app and on every report and document you export. The settings below are locked on your current plan.</p>
