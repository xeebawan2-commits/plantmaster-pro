 ...
 */
const C='plantmaster-pro-v4.31.2';
const F=['./','./index.html','./styles.css?v=4.11.1','./ui-v4.5.css?v=4.11.1','./scanner-v4.8.css?v=4.11.1','./condition-v4.9.css?v=4.11.1','./solver-v4.11.css?v=4.11.1','./theme-pro.css?v=2.1.0','./app.js?v=4.31.2','./scanner.js?v=4.11.1','./condition.js?v=4.11.1','./solver.js?v=4.11.1','./config.js?v=4.3.1','./offline.js?v=4.11.1','./operations.js?v=4.30.0','./procurement.js?v=1.0.2','./csv-import.js?v=1.0.1','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/maskable-512.png'];
