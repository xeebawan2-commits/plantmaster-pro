 ...
 */
const C='plantmaster-pro-v4.44.0';
const F=['./','./index.html','./styles.css?v=4.11.1','./ui-v4.5.css?v=4.11.1','./scanner-v4.8.css?v=4.11.1','./condition-v4.9.css?v=4.11.1','./solver-v4.11.css?v=4.11.1','./theme-pro.css?v=4.32.0?vv=2.1.0','./app.js?v=4.43.0','./scanner.js?v=4.11.1','./condition.js?v=4.11.1','./solver.js?v=4.11.1','./config.js?v=4.3.1','./offline.js?v=4.11.1','./operations.js?v=4.33.1','./procurement.js?v=1.1.0','./csv-import.js?v=1.0.2','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/maskable-512.png'];
...
if(new URL(e.request.url).pathname.endsWith('/app.js'))return e.respondWith(fetch(e.request,{cache:'no-store'}).catch(()=>caches.match(e.request)));
