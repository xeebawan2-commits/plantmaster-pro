# 05 owner invitations

_Invite owners; create login; revoke; delete; cleanup._

## 1. App section / UI
| File | Role |
|---|---|
| `app.js` | Invitations list + inviteOwner() |

## 2. Schema / SQL
Full DDL for this section is in **`schema.sql`** (extracted from the sources below).

**Tables:** `owner_invitations`

**RPCs / functions:** `control_invite_owner()`, `control_revoke_owner_invitation()`, `control_delete_owner_invitation()`
