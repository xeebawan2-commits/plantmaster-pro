# 03 accounts and users

_User accounts: create login, reset password, ban/unban, delete._

## 1. App section / UI
| File | Role |
|---|---|
| `app.js` | Accounts list; createOwnerLogin() -> create-owner |
...
**RPCs / functions:** `control_accounts()`, `platform_ban_user()`, `platform_delete_user()`

**Defined in:** 0001_foundation.sql, 02-function-source.sql (LIVE snapshot)
