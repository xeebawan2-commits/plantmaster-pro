...
_Platform overview: counts of companies, accounts, requests, storage._

## 1. App section / UI
| File | Role |
|---|---|
| `index.html` | Login + shell |
| `app.js` | Dashboard render |
| `config.js` | URL, anon key, app URL, WA |
...
**RPCs / functions:** `control_dashboard()`, `is_platform_admin()`
